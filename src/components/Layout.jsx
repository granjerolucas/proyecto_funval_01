      ...
      <main className="flex-grow container mx-auto p-4">
        <div className="flex flex-col gap-4 h-[calc(100vh-5rem)]">
          <div className="flex gap-4 h-2/3">
            <Link to="/albums" className="w-1/2 bg-white rounded-lg shadow-sm p-4 flex items-center justify-center hover:bg-gray-50 transition-colors">
              <h2 className="text-lg font-semibold text-gray-700 text-center">Albums</h2>
            </Link>
            <Link to="/posts" className="w-1/2 bg-white rounded-lg shadow-sm p-4 flex items-center justify-center hover:bg-gray-50 transition-colors">
              <h2 className="text-lg font-semibold text-gray-700 text-center">Posts</h2>
            </Link>
          </div>
          <Link to="/todos" className="h-1/3 bg-white rounded-lg shadow-sm p-4 flex items-center justify-center hover:bg-gray-50 transition-colors">
